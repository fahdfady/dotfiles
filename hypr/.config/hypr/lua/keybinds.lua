...
hl.define_submap("global", function()
    ...
    hl.bind("SUPER + SUPER_R", hl.dsp.global("quickshell:overviewToggleRelease"), { ignore_mods = true, description = "Toggle overview" })
    hl.bind("SUPER + SUPER_L", hl.dsp.exec_cmd("qs -c " .. qsConfig .. " ipc call TEST_ALIVE || fuzzel"))
    hl.bind("SUPER + SUPER_R", hl.dsp.exec_cmd("qs -c " .. qsConfig .. " ipc call TEST_ALIVE || fuzzel"))
    ...
    hl.bind("SUPER + mouse:272", hl.dsp.global("quickshell:overviewToggleReleaseInterrupt"), { mouse = true })
    hl.bind("SUPER + mouse:273", hl.dsp.global("quickshell:overviewToggleReleaseInterrupt"), { mouse = true })
    hl.bind("SUPER + mouse:274", hl.dsp.global("quickshell:overviewToggleReleaseInterrupt"), { mouse = true })
    hl.bind("SUPER + mouse:275", hl.dsp.global("quickshell:overviewToggleReleaseInterrupt"), { mouse = true })
    hl.bind("SUPER + mouse:276", hl.dsp.global("quickshell:overviewToggleReleaseInterrupt"), { mouse = true })
    hl.bind("SUPER + mouse:277", hl.dsp.global("quickshell:overviewToggleReleaseInterrupt"), { mouse = true })
    hl.bind("SUPER + mouse_up", hl.dsp.global("quickshell:overviewToggleReleaseInterrupt"), { mouse = true })
    hl.bind("SUPER + mouse_down", hl.dsp.global("quickshell:overviewToggleReleaseInterrupt"), { mouse = true })
    ...
    hl.bind("CTRL + SUPER + T", hl.dsp.exec_cmd("qs -c " .. qsConfig .. " ipc call TEST_ALIVE || ~/.config/quickshell/" .. qsConfig .. "/scripts/colors/switchwall.sh"), { description = "Change wallpaper" })
    ...
    hl.bind("SUPER + SHIFT + T", hl.dsp.exec_cmd('grim -g "$(slurp $SLURP_ARGS)" "tmp.png" && tesseract "tmp.png" - | wl-copy && rm "tmp.png"'), { description = "Character recognition" })
    ...
    hl.bind("CTRL + ALT + R", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/record.sh --fullscreen"), { description = "Record screen (no sound)" })
    ...
    hl.bind("SUPER + ALT + 1", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspacesilent 1"))
    hl.bind("SUPER + ALT + 2", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspacesilent 2"))
    hl.bind("SUPER + ALT + 3", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspacesilent 3"))
    hl.bind("SUPER + ALT + 4", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspacesilent 4"))
    hl.bind("SUPER + ALT + 5", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspacesilent 5"))
    hl.bind("SUPER + ALT + 6", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspacesilent 6"))
    hl.bind("SUPER + ALT + 7", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspacesilent 7"))
    hl.bind("SUPER + ALT + 8", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspacesilent 8"))
    hl.bind("SUPER + ALT + 9", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspacesilent 9"))
    hl.bind("SUPER + ALT + 0", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh movetoworkspacesilent 10"))

    hl.bind("SUPER + SHIFT + mouse_down", hl.dsp.window.move({ workspace = "r-1" }), { mouse = true })
    hl.bind("SUPER + SHIFT + mouse_up", hl.dsp.window.move({ workspace = "r+1" }), { mouse = true })
    hl.bind("SUPER + ALT + mouse_down", hl.dsp.window.move({ workspace = "-1" }), { mouse = true })
    hl.bind("SUPER + ALT + mouse_up", hl.dsp.window.move({ workspace = "+1" }), { mouse = true })
    ...
    -- Workspace
    ---------------------------------
    hl.bind("SUPER + 1", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh workspace 1"))
    hl.bind("SUPER + 2", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh workspace 2"))
    hl.bind("SUPER + 3", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh workspace 3"))
    hl.bind("SUPER + 4", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh workspace 4"))
    hl.bind("SUPER + 5", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh workspace 5"))
    hl.bind("SUPER + 6", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh workspace 6"))
    hl.bind("SUPER + 7", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh workspace 7"))
    hl.bind("SUPER + 8", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh workspace 8"))
    hl.bind("SUPER + 9", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh workspace 9"))
    hl.bind("SUPER + 0", hl.dsp.exec_cmd("~/.config/hypr/hyprland/scripts/workspace_action.sh workspace 10"))
    ...
    hl.bind("CTRL + SUPER + mouse_up", hl.dsp.focus({ workspace = "r+1" }), { mouse = true })
    hl.bind("CTRL + SUPER + mouse_down", hl.dsp.focus({ workspace = "r-1" }), { mouse = true })

    hl.bind("SUPER + S", hl.dsp.workspace.toggle_special(""), { description = "Toggle scratchpad" })
    hl.bind("SUPER + mouse:275", hl.dsp.workspace.toggle_special(""), { mouse = true })
    ...
    hl.bind("SUPER + MINUS", hl.dsp.exec_cmd("qs -c " .. qsConfig .. " ipc call TEST_ALIVE || ~/.config/hypr/hyprland/scripts/zoom.sh decrease 0.1"), { repeating = true })
    hl.bind("SUPER + EQUAL", hl.dsp.exec_cmd("qs -c " .. qsConfig .. " ipc call TEST_ALIVE || ~/.config/hypr/hyprland/scripts/zoom.sh increase 0.1"), { repeating = true })
    ...
    hl.bind("SUPER + SHIFT + ALT + mouse:275", hl.dsp.exec_cmd("playerctl previous"), { mouse = true })
    hl.bind("SUPER + SHIFT + ALT + mouse:276", hl.dsp.exec_cmd('playerctl next || playerctl position `bc <<< "100 * $(playerctl metadata mpris:length) / 1000000 / 100"`'), { mouse = true })
