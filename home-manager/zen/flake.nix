# dotfiles/zen/flake.nix
{
  ...
  outputs = { self, nixpkgs }: let
    ...
    # Local tarball setup
    zenTarball = ./pkgs/zen.linux-x86_64.tar.bz2;
    zenHash = "sha256-hiGb2oyAueKa6Xs6BvtEmgPTRlOXvJ5YDseS8kZ1VbQ=";  # Get hash with: nix hash file ./path/zen.linux-x86_64.tar.bz2
