// Vendored from Omarchy's network panel Model.js
// (/usr/share/omarchy/shell/plugins/panels/network/Model.js).
// Pure functions only: import in QML via `import "omarchy/NetworkModel.js" as NetModel`
// and test under node via the module.exports guard at the bottom.
// Upstream changes (icon glyphs, band boundaries, failure reasons) can be
// re-synced by copying that file over this one.
